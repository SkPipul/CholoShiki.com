...
const Instructors = () => {
  return (
    <div className="py-32 bg-[#123BC6] px-10">
      ...
      <div className="grid grid-cols-5 gap-8 mt-12 group">
        <div className="bg-black/40 py-4 rounded-md group-hover:blur-sm hover:!blur-none group-hover:scale-[0.85] hover:!scale-100 group-hover:shadow-xl hover:!shadow-xl duration-300 cursor-pointer">
