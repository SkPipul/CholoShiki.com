  ...
  return (
    <footer>
      <div className="footer p-10 bg-[#010B2E] text-neutral-content">
        <div>
          <p className="flex items-center">
            <span className="text-orange-500 text-3xl flex items-center gap-2 font-extrabold">
              <GiBurningBook></GiBurningBook>CholoShiki
            </span>
            <span className="text-xl ml-1 font-bold">.com</span>
          </p>
          <p>
            CholoShiki.com Industries Ltd.
            <br />
      ...
      <div className="footer footer-center p-4 bg-black text-white">
        <div>
          <p>
            Copyright © 2023 - All right reserved by CholoShiki.com Industries
            Ltd
          </p>
        </div>
      </div>
